...
footer.className = "p-10 bg-[#18182F] grid grid-cols-2 text-[#BABAEE] text-sm";
footer.innerHTML = `
      <div>
        <svg
        ...
        <p class="font-semibold">SohanEmon<br />Full Stack Developer</p>
      </div>
      <div>
        <span class="footer-title">Social</span>
        <div class="flex mt-4 gap-4">
          <a class='cursor-pointer' href="https://twitter.com/sohanemon" target='_blank'
            ><svg
              xmlns="http://www.w3.org/2000/svg"
              width="24"
              height="24"
            ...
            >
              ...
              ></path></svg
          ></a>
          <a class='cursor-pointer' href="https://youtube.com/sohanurrahmanemon" target='_blank'
            ><svg
              xmlns="http://www.w3.org/2000/svg"
              width="24"
              height="24"
            ...
            >
              ...
              ></path></svg
          ></a>
          <a class='cursor-pointer' href="https://facebook.com/m.sohanemon" target='_blank'
            ><svg
              xmlns="http://www.w3.org/2000/svg"
              width="24"
              height="24"
